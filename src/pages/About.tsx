...
const team = [
  {
    name: "Tammy",
    role: "Founder & Host",
    desc: "The heart and soul of Akihi Tales. We are a passionate traveler and host who believes every trip should feel personal, safe, and magical. Our warmth and attention to detail make every guest feel at home in the mountains.",
    emoji: "🏔️",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Our founder and our team of local experts bring years of experience and authentic knowledge of the Himalayas to every trip. We don't just plan itineraries — we pour our hearts into every experience.
                </p>
                <p>
