        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div>
                <p className="text-foreground font-semibold text-sm">Instagram</p>
      ...
      <section className="py-16 px-4 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {/* Form */}
            <div>
              <h2 className="font-display text-3xl font-bold text-foreground mb-3">Send Us a Message</h2>
              ...
              {submitted ? (
                <div className="glass-card p-10 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Thanks {form.name || ""}! We'll reach out on <strong className="text-foreground">+{form.phone}</strong> within 24 hours.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="text-foreground/80 text-sm font-medium flex items-center gap-2 mb-2">
                      <MapPin className="w-4 h-4 text-primary" /> Package / Activity
                    </label>
                    <select
                      name="pkg"
                      value={form.pkg}
                      onChange={handleChange}
                      required
                      className="w-full bg-muted border border-border rounded-xl px-4 py-3 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-ring transition-all"
                    >
            ...
            <div className="space-y-6">
              <div className="glass-card p-6">
                <h3 className="font-display text-xl font-bold text-foreground mb-4">Find Us in Rishikesh</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="text-foreground text-sm font-medium">Rishikesh, Uttarakhand, India</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://instagram.com/akihi_tales" target="_blank" rel="noopener noreferrer" className="text-foreground text-sm hover:text-primary transition-colors">instagram.com/akihi_tales</a>
                  </div>
                </div>
              </div>
